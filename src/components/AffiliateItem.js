...
export function AffiliateItem({color,title,dateFrom,dateTo,money,image,user}){
    return(
        <TouchableOpacity style={styles.flexRow}>
            <View style={{flex:1,justifyContent:'center'}}>
                <View style={{backgroundColor:color,height:140,width:4,borderRadius:50}}></View>
            </View>
            <View style={{flex:4,alignItems:'center',justifyContent:'center',marginLeft:-20,marginRight:8}}>
